      ...
      >
        ...
        >
          ...
          <motion.h1
            ...
            className={`${theme === "light" ? "text-primary" : "text-altPrimary"} font-semibold lg:text-[4rem] md:text-[2.8rem] text-[2.5rem] leading-[120%] mt-2 mb-4`}
          >
            {name}
          </motion.h1>
          <motion.h3
          ...
          <motion.p
            ...
            className={`${theme === "light" ? "text-[#777777]" : "text-[#a9afc3]"} font-medium text-[16px] max-w-[500px] mb-8 `}
          >
            {description[0]}
          </motion.p>
