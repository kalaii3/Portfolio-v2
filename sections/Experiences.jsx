    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <SectionSubtitle className="lg:text-end text-end">Skills Stack</SectionSubtitle>
            <motion.p
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center order-1 lg:text-start text-center">
            <SectionSubtitle className="lg:text-start">Tools Stack</SectionSubtitle>
            <motion.p
              variants={textVariants(1.2)}
            ...
            >
              There are some Tools I used to make my work easier
            </motion.p>
          </div>
          ...
          >
            {ToolsList.map(({ ToolIcon, title}, index) => (
              <motion.div
                variants={fadeIn("up", "tween", index * 0.1, 1.1)}
                key={index}
                className="flex flex-col justify-center items-center gap-y-3 group cursor-pointer"
